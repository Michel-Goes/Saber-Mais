/**
 * Main JavaScript file for Saber Mais project
 * Handles navigation, login, and core application functionality
 */

/* Navigation module - Manages page navigation and user interface */
const Navigation = {
  init() {
  ...
  // Updates user name display in navigation bar
  updateUserName() {
  ...
  // Sets up logout functionality with user confirmation
  setupLogout() {
...
const Login = {
  ...
  // Gets DOM elements for form interaction
  getElements() {
    return {
  ...
  // Displays validation error message for form inputs
