/**
 * Lessons module - Manages lesson tabs and progress tracking
 */
const Lessons = {
    // Displays the selected lesson tab and updates UI
    showTab(name) {
    ...
    // Handles click events on lesson tab buttons
    handleTabClick(e) {
    ...
    // Creates modal overlay for video playback
